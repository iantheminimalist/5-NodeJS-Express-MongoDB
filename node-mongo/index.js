...
MongoClient.connect(url, { useUnifiedTopology: true }).then(client => { //to connect to mongo db server
    ...
    .then(result => { //delete the old contents 
    ...
    .then(result => {
        console.log('Updated Document Count:', result.result.Modified);
